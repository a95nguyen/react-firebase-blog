...
function App() {
  const [posts, setPosts] = useState([
    ...
    },
    {
      id: 2,
      title: 'Life Goes On',
      quote: 'If this can no longer resonate with me / If this can no longer make my heart flutter / Perhaps, this will be how I die once',
      gif: 'https://media.tenor.com/images/63fadc6e01f477acb05d70722205c624/tenor.gif',
